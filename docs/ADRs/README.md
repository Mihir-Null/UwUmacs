...
| [ADR-0003](0003-native-literal-dispatch.md) | Use native literal prefix lookup | selected | agent-selected | planned |
| [ADR-0004](0004-owned-state-layer.md) | Own a reversible state-aware emulation layer | selected | agent-selected | planned |
| [ADR-0005](0005-composition-and-conflicts.md) | Compose localleaders and reject ambiguous defaults | selected | agent-selected | planned |
...
| [ADR-0009](0009-literate-files-and-modules.md) | Keep flat generated outputs and focused modules | selected | agent-selected | planned |
...
| [ADR-0019](0019-wave-1a-core.md) | Foundational library contracts | selected | agent-selected | planned |
...
| [ADR-0036](0036-review-first-development-handoff.md) | Review alignment before subagent development and retain execution state | accepted | user-workflow-with-agent-record-layout | Phase 1 and P00 complete; entry point replaced by ADR-0037; P01 onward paused |
| [ADR-0037](0037-execution-contract-replaces-handoff.md) | Retire the consumed handoff; preserve the standing execution contract | accepted | user-request-with-agent-record-layout | migration complete; P01 onward paused |

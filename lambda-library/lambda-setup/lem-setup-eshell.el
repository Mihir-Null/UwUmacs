...
(use-package pcmpl-homebrew
  :when (and lem-load-extras (locate-library "pcmpl-homebrew"))
  :after eshell)

(use-package pcmpl-args
  :when (and lem-load-extras (locate-library "pcmpl-args"))
  :after eshell)

(use-package pcomplete-extension
  :when (and lem-load-extras (locate-library "pcomplete-extension"))
  :after eshell)

;; Provide help support -- see also the info function below
(use-package esh-help
  :when (and lem-load-extras (locate-library "esh-help"))
  :after eshell
  :config
  ;; Eldoc support.
...
(use-package eshell-up
  :when (and lem-load-extras (locate-library "eshell-up"))
  :commands (eshell-up)
  :config
...
(use-package eshell-syntax-highlighting
  :when (and lem-load-extras (locate-library "eshell-syntax-highlighting"))
  :after eshell
  :config

...
(use-package dired-narrow
  :when (and lem-load-extras (locate-library "dired-narrow"))
  :bind* (:map dired-mode-map
          ("/" . dired-narrow)))
...
;;;; Dired Colors
(use-package diredfl
  :when (and lem-load-extras (locate-library "diredfl"))
...
(use-package peep-dired
  :when (and lem-load-extras (locate-library "peep-dired"))
  :after dired
  :commands (peep-dired)
  :bind* (:map dired-mode-map
          ("P" . peep-dired)
...
(use-package dired-ranger
  :when (and lem-load-extras (locate-library "dired-ranger"))
  :after dired
  :bind (:map dired-mode-map

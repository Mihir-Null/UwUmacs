;;; lem-setup-org-extensions.el --- org extensions -*- lexical-binding: t -*-
...
(use-package org-appear
  :when (and lem-load-extras (locate-library "org-appear"))
...
(use-package org-modern
  :when (and lem-load-extras (locate-library "org-modern"))
...
(use-package org-autolist
  :when (and lem-load-extras (locate-library "org-autolist"))
...
(use-package org-download
  :when (and lem-load-extras (locate-library "org-download"))
...
(use-package ox-pandoc
  :when (and lem-load-extras (locate-library "ox-pandoc") (executable-find "pandoc"))
...
(use-package ox-hugo
  :when (and lem-load-extras (locate-library "ox-hugo"))
...
;;; Org Html Conversion
(use-package htmlize
  :when (and lem-load-extras (locate-library "htmlize"))
  :commands (htmlize-buffer))

;;; Org Mac Link
(when sys-mac
  (use-package org-mac-link
    :when (and lem-load-extras (locate-library "org-mac-link"))
    :after org
...
(use-package org-pomodoro
  :when (and lem-load-extras (locate-library "org-pomodoro"))

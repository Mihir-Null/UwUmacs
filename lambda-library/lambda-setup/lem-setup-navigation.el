...
(use-package dired-sidebar
  :when (and lem-load-extras (locate-library "dired-sidebar"))
...
(use-package imenu-list
  :when (and lem-load-extras (locate-library "imenu-list"))
...
(use-package goto-last-change
  :when (and lem-load-extras (locate-library "goto-last-change"))

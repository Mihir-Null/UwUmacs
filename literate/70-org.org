...
#+STARTUP: overview
#+PROPERTY: header-args:emacs-lisp :tangle ../lisp/uwumacs-org.el :eval never :comments no :padline no :mkdirp yes
...
=uwumacs-org-directory= comes from [[file:30-platform.org][the platform chapter]] so a machine can
